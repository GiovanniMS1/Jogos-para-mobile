...
public class MobileJoystick : MonoBehaviour, IDragHandler, IEndDragHandler
{
    ...
    /// <summary>
    /// The original position of the stick used to calculate the offset of movement
    /// </summary>
    ...
    /// </summary>
    /// <param name="eventData">Information about the  movement, 
    /// we are only using the position</param>
